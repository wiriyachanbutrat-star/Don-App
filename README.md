...
|---|---|---|---|---|---|---|---|
| **H4** ✅ | ~2.8 ปี | 46 | **58%** | **+0.50R** | +22.8R | **2.4** | **3R** |
| H1 ❌ | ~7 เดือน | 23 | 26% | −0.41R | −9R | 0.39 | 11R |
| M15/M30 ❌ | ~1–3 เดือน | — | ~30–42% | ติดลบ | — | — | — |

**สรุป: มี edge จริงบน H4 เท่านั้น** — win rate ~58% (ไม่ใช่ 70% — mechanical gold system
ที่กำไรระยะยาวมัก 45–58%) แต่ **ไม้ชนะใหญ่กว่าไม้แพ้ 2.4 เท่า** (PF 2.4) และ drawdown เล็ก (~3R
ใน 2.8 ปี) · ~1.4 ไม้/เดือน · H1 ลงมาไม่มี edge — สัญญาณเยอะแต่แพ้บ่อย ·
เดิม (score ≥ 64, TP 0.5R) ก็ยังมีอยู่ที่ `mode=institutional`
