...
| Entry TF | ช่วง (34 เดือน) | เทรด | Win rate | กำไร/ไม้ | รวม (R) | PF | Max DD |
|---|---|---|---|---|---|---|---|
| **H4** ✅ (High-Confidence, ปัจจุบัน) | ~2.8 ปี | 25 | **65%** | **+0.62R** | +15.5R | **2.9** | **~4R** |
| H4 (เกณฑ์เดิม, ก่อนเพิ่ม MA+RSI gate) | ~2.8 ปี | 46 | 58% | +0.50R | +22.8R | 2.4 | 3R |
