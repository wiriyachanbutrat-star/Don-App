...
function analyze({ assetKey = 'XAU', interval = '1h', entryCandles, structureCandles, trendCandles }) {
  ...
  return buildResult({ assetKey, interval, stack, price, atr, ema50Entry, trend, trendDirWord, structTF, structWord, structEntry, bar, direction, score, checklist, srLevel, srZone, isHtfLevel, priorDay: pdl, atSR, bos, retest, rej, qm: qmSide, qmMatch, cfg, entryTime: entryCandles[n - 1].time });
}
