...
function computeSignalScore(m) {
  ...
  // ADX >= 22 is the trade gate — a middle ground within Wilder's "emerging
  // trend" band (20-25) — and the score must also clear strongThreshold — a
  // bare non-zero score (e.g. a single +1 vote) is not enough confluence to
  // trade on its own.
  let tradable = true;
  let waitReason = null;
