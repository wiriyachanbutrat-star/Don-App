...
function computeSignalScore(m) {
  ...
  // ADX >= 18 is the trade gate — loosened from the stricter >=25
  // "professional checklist" threshold so setups fire more often; still
  // blocks the clearly dead-flat markets (ADX<18) where trend-following
  // signals here whipsaw the most.
  let tradable = true;
  let waitReason = null;
